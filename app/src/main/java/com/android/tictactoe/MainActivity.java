...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int players1Points = 0;
    private int players2Points = 0;
    ...
    private  void draw(){
        ...
        textViewPlayer1.setText("Player 1 :"+players1Points);
        textViewPlayer2.setText("Player 2 :"+players2Points);
        }
